 ...
 ************************************************************************
 */
void intrapred_4x4(ColorPlane pl, int img_x,int img_y, int *left_available, int *up_available, int *all_available)
{
  int i,j;
  int s0;
 ...
 ************************************************************************
 */
void intrapred_16x16(ColorPlane pl)
{
  int s0=0,s1,s2;
  imgpel s[2][16];
  int i,j;
...
int dct_4x4_qpprime(Macroblock *currMB, ColorPlane pl, int block_x,int block_y,int *coeff_cost, int intra)
{
  ...
  __declspec(align(16)) static int m4[16][16];
# else
  static int m4[16][16] __attribute__ ((aligned (16)));
# endif
#else
  static int m4[16][16];
#endif
