...
int coeff_cost1, coeff_cost2;
int cmp_cbp[2], i16x16mode, curr_cbp[2];
...
void intrapred_4x4   (ColorPlane pl, int CurrPixX,int CurrPixY, int *left_available, int *up_available, int *all_available);
